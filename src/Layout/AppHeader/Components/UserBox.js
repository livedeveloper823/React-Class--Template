                            ...
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right me-2">
                                <Button
                                  ...
                                  color="focus"
                                >
                                  <a href="/pages/login" style={{textDecoration:'none', color:'white'}}>Logout</a>
                                </Button>
                              </div>
                            </div>
                          </div>
                    ...
                    >
                      <PerfectScrollbar>
                        <Nav vertical>
                          ...
                          <NavItem>
                            <NavLink href="#/dashboards/manageuser">
                              Manage Users
                          ...
                          <NavItem>
                            <NavLink href="#/pages/forgot-password">Change Password</NavLink>
                          </NavItem>
                          {/* <NavItem className="nav-item-header">
                            My Account
                          </NavItem>
